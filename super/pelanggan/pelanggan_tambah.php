...
while ($row = mysqli_fetch_array($hasil)) {
    ?>
                        <option value="<?php echo $row['id_layanan'] ?>"><?php echo $row['layanan'] ?>| <?php echo rupiah($row['tarif_dasar']); ?></option>
                        <?php
}
?>
                        </select>
                    ...
                    <div>
                        ...
                        <a href="?halaman=pelanggan_tampil" title="Kembali" class="btn btn-default">Batal</a>
                    </div>
            </div>
            </form>
        </div>
