		...
		<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<center>
						<h5>
							<b>Aplikasi Pembayaran Tagihan Air</b>
						</h5>
						<center>
				</div>
			...
			<center>
				<h5>
					<b>Copyright © KKN T Undip - Punjulharjo 2020
						<b>
				</h5>
			</center>
		</div>
    ...
    if ($jumlah_login == 1) {
        ...
        echo "<script>
                        Swal.fire({title: 'Login Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
                            ...
                            if (result.value) {
                                window.location = 'http://localhost/pamsimas_punjulharjo';
                            }
                        })</script>";
    } else {
        echo "<script>
